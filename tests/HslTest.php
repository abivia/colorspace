...
class HslTest extends TestCase
{
    ...
    {
        $obj = new Hsl(90, 0.25, 0.25);
        $this->assertEquals(0.25, round($obj->getHue(), 10));
        $this->assertEquals(0.25, round($obj->getSaturation(), 10));
        $this->assertEquals(0.25, round($obj->getLightness(), 10));
    ...
    public function testFromCssHsl()
    {
        ...
        $color->setAlpha(0.2);
        $this->assertEquals('hsla(180 10% 25% / 0.2)', $color->toCss());
        $this->assertEquals('hsla(180, 10%, 25%, 0.2)', $color->toCss(true));
    }
